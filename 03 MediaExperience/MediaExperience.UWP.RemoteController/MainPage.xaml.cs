    ...
    public sealed partial class MainPage : Page
    {
        ...
        private async void button_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (_appServiceConnection == null)
            {
                ...
                _appServiceConnection.PackageFamilyName = 
                    //"4aaa9320-e7ef-4637-9f0b-7eb229e27a26_v2eq8qs7wm15j";// old
                    "4aaa9320-e7ef-4637-9f0b-7eb229e27a26_cj4nrm0qt9s1y";// new
        ...
        private void LaunchApp_Click(object sender, RoutedEventArgs e)
        {
            ...
            // TODO : RnD Launch Scenario
            
            //if (content != null)
            //    message.Add("Command", "Launch");//content.ToString());
