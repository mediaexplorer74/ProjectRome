...
namespace MediaExperience.Droid
{
        ...
        MediaPlayer.IOnInfoListener
    {
        ...
        /// </summary>
        public bool IsReadyRendering => RenderSurface != null && !((VideoSurface)RenderSurface).IsDisposed;
        ...
        public TimeSpan Duration => IsReadyRendering == false ? TimeSpan.Zero : TimeSpan.FromSeconds(VideoViewCanvas.Duration / 1000.0d);
        
        public TimeSpan Position => IsReadyRendering == false ? TimeSpan.Zero : TimeSpan.FromSeconds(VideoViewCanvas.CurrentPosition / 1000.0d);
